...
VALUES (UUID(), utc_timestamp, 'flyway:migration', utc_timestamp, 'flyway:migration', 'ADMINISTRATOR', 'ADMINISTRATOR profile - must not delete',
        'ADMINISTRATOR');
...
VALUES (UUID(), utc_timestamp, 'flyway:migration', utc_timestamp, 'flyway:migration', 'admin', 'ADMINISTRATOR user - must not delete',
        '$2a$12$hs0fsTRcWifujBZpT4mQoOmBLB/5Bf4z1uAlOV4os6SUmHDiY6uuC', (SELECT id FROM profile where type like 'ADMINISTRATOR'));
